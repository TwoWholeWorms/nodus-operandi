...
namespace NodusOperandi.Data
{
    ...
    public class MongoDbStatisticsRepository : IStatisticsRepository
    {
        ...
        {
            this.collection = database.GetCollection<StatisticsModel>(Configuration.DatabaseName);
        }
        ...
        {
            this.collection.Remove(Query<StatisticsModel>.Where(statistics => statistics.Id == id));
        }
