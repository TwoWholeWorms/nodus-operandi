...
namespace NodusOperandi.Data
{
    ...
    public class MongoDbSettingRepository : ISettingRepository
    {
        ...
        {
            this.collection = database.GetCollection<SettingModel>(Configuration.DatabaseName);
        }
        ...
        {
            this.collection.Remove(Query<SettingModel>.Where(setting => setting.Id == id));
        }
        ...
        {
            return this.collection.Find(Query<SettingModel>.Where(setting => setting.Section == section));
        }
